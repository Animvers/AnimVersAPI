 ...
 */
final class Version20260501184026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profil (id INT AUTO_INCREMENT NOT NULL, image_profil LONGTEXT NOT NULL, bio VARCHAR(255) NOT NULL, user_id_id INT DEFAULT NULL, INDEX IDX_E6D6B2979D86650F (user_id_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
