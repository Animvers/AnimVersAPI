 ...
 */
final class Version20260813134225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sondage (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, is_active TINYINT NOT NULL, question VARCHAR(255) NOT NULL, create_at DATETIME NOT NULL, image_url LONGTEXT DEFAULT NULL, category_name VARCHAR(255) NOT NULL, who_make_it_id_id INT DEFAULT NULL, INDEX IDX_7579C89F2077FE30 (who_make_it_id_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
